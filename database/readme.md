...
O schema ainda não foi implementado. A modelagem, as constraints de isolamento e a
estratégia contra conflitos de horario serão concluídas nas Fases 0 e 2 do roadmap.
...
2. Para aplicar as alterações de schema no banco de dados, a partir de `backend/`:
